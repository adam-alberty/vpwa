...
export const channels: Channel[] = [
  {
    ...
    name: 'frontend-dev',
    // latestMessage: 'alex: Can someone review my PR for the navbar updates?',
    isPrivate: true,
    newMessageCount: 1,
  },
  {
    ...
    // latestMessage: 'maria: I’ve updated the Q4 goals in the doc, feedback welcome.',
    isPrivate: true,
    newMessageCount: 4,
  },
  {
    ...
    name: 'general',
    // latestMessage: 'josh: Reminder: All hands at 2pm today!',
    isPrivate: true,
    newMessageCount: 2,
  },
  {
    ...
    // latestMessage: 'lina: Pushed the latest Figma updates for the onboarding flow.',
    isPrivate: true,
    newMessageCount: 1,
  },
  {
    ...
    // latestMessage: 'ben: Ticket #3487 needs escalation — login still failing.',
    newMessageCount: 1,
  },
  {
    id: 'd61cb376-ef84-4521-a53e-7b167dd0c37a',
    name: 'random',
    // latestMessage: 'chloe: Anyone else trying the new coffee place on 3rd?',
    newMessageCount: 1,
  },
  {
    id: 'ee6e63c1-3cf2-4bc1-950b-41b68220b3a7',
    name: 'qa-testing',
    // latestMessage: 'samir: Found a bug in the checkout flow on iOS.',
  },
  {
    id: 'f96a119e-39f2-404e-88fc-1c6727e11673',
    name: 'backend-infra',
    // latestMessage: 'dan: Deployed the hotfix to production. Monitoring logs now.',
  },
  {
    id: '3785b8f3-96e4-4fd0-a6ec-2c842e877eab',
    name: 'marketing',
    // latestMessage: 'tina: Drafted copy for the new landing page — thoughts?',
  },
  {
    id: 'c8fd594e-4de6-4fc4-8231-1c4dfabaf70a',
    name: 'sales-leads',
    // latestMessage: 'rob: Meeting with Acme Corp went well. Follow-up scheduled.',
  },
  {
    id: '6af043bd-d7c4-4d2e-9f29-2e8a2e746d91',
    name: 'devops',
    // latestMessage: 'nina: Pipeline failed on staging — investigating now.',
  },
  {
    id: 'e4a17e93-dae5-40ae-9c24-d4b16a20bb5e',
    name: 'weekly-sync',
    // latestMessage: 'matt: Can we push the meeting to 3pm?',
  },
  {
    id: '37d7ebf4-e8cc-470e-a3ed-41b2353a0c49',
    name: 'support-escalations',
    // latestMessage: 'dave: Customer still seeing 500 errors after patch.',
  },
  {
    id: '9eaf07e7-43e4-4f9a-ae1c-12cfb3793427',
    name: 'hiring',
    // latestMessage: 'sara: Two new resumes in the shared folder.',
  },
  {
    id: '73dc38a0-61e7-4701-8c9b-3cd8b6c21490',
    name: 'mobile-app',
    // latestMessage: 'ken: Pushed the latest build to TestFlight.',
  },
  {
    id: '2fa6d3a1-bba2-43ff-b3a6-e94e027d7a2c',
    name: 'ux-feedback',
    // latestMessage: 'julia: Users are confused by the onboarding step 3.',
  },
  {
    id: 'b1a9ed36-1d74-4098-913f-826d0558c1ce',
    name: 'engineering',
    // latestMessage: 'leo: API v2 is now live 🚀',
  },
  {
    id: '90a81f5f-650a-406f-8c5f-155e9f4f2ac0',
    name: 'analytics',
    // latestMessage: 'emma: September traffic up 12% from last month.',
  },
  {
    id: 'c3cba6b2-27f7-4cbb-a3a6-67210e943e6d',
    name: 'partners',
    // latestMessage: 'jack: Call with Stripe team moved to Thursday.',
  },
  {
    id: '7ddfb61c-cde5-4bb1-94dc-06b5eb173b87',
    name: 'social-media',
    // latestMessage: 'mia: Scheduled the October posts — ready for review.',
  },
];
